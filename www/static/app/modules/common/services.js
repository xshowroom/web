/**
 * @file all services of xshowroom
        ...
        function () {
            return {
                getAll: function (opts) {
                    return [
                        'Angola', 'Afghanistan', 'Albania', 'Algeria', 'Andorra', 'Anguilla',
                        'AntiguaandBarbuda', 'Argentina', 'Armenia', 'Ascension', 'Australia',
                        'Austria', 'Azerbaijan', 'Bahamas', 'Bahrain', 'Bangladesh', 'Barbados',
                        'Belarus', 'Belgium', 'Belize', 'Benin', 'BermudaIs', 'Bolivia', 'Botswana',
                        'Brazil', 'Brunei', 'Bulgaria', 'Burkina_faso', 'Burma', 'Burundi',
                        'Cameroon', 'Canada', 'CaymanIs', 'CentralAfricanRepublic', 'Chad',
                        'Chile', 'China', 'Colombia', 'Congo', 'CookIs', 'CostaRica', 'Cuba',
                        'Cyprus', 'CzechRepublic', 'Denmark', 'Djibouti', 'DominicaRep', 'Ecuador',
                        'Egypt', 'EISalvador', 'Estonia', 'Ethiopia', 'Fiji', 'Finland', 'France',
                        'FrenchGuiana', 'Gabon', 'Gambia', 'Georgia', 'Germany', 'Ghana', 'Gibraltar',
                        'Greece', 'Grenada', 'Guam', 'Guatemala', 'Guinea', 'Guyana', 'Haiti',
                        'Honduras', 'Hongkong', 'Hungary', 'Iceland', 'India', 'Indonesia', 'Iran',
                        'Iraq', 'Ireland', 'Israel', 'Italy', 'IvoryCoast', 'Jamaica', 'Japan',
                        'Jordan', 'Kampuchea_Cambodia', 'Kazakstan', 'Kenya', 'Korea', 'Kuwait',
                        'Kyrgyzstan', 'Laos', 'Latvia', 'Lebanon', 'Lesotho', 'Liberia', 'Libya',
                        'Liechtenstein', 'Lithuania', 'Luxembourg', 'Macao', 'Madagascar', 'Malawi',
                        'Malaysia', 'Maldives', 'Mali', 'Malta', 'MarianaIs', 'Martinique', 'Mauritius',
                        'Mexico', 'Moldova_Republicof', 'Monaco', 'Mongolia', 'MontserratIs', 'Morocco',
                        'Mozambique', 'Namibia', 'Nauru', 'Nepal', 'NetheriandsAntilles', 'Netherlands',
                        'NewZealand', 'Nicaragua', 'Niger', 'Nigeria', 'NorthKorea', 'Norway', 'Oman',
                        'Pakistan', 'Panama', 'PapuaNewCuinea', 'Paraguay', 'Peru', 'Philippines',
                        'Poland', 'FrenchPolynesia', 'Portugal', 'PuertoRico', 'Qatar', 'Reunion',
                        'Romania', 'Russia', 'SaintLueia', 'SaintVincent', 'SamoaEastern', 'SamoaWestern',
                        'SanMarino', 'SaoTomeandPrincipe', 'SaudiArabia', 'Senegal', 'Seychelles',
                        'SierraLeone', 'Singapore', 'Slovakia', 'Slovenia', 'SolomonIs', 'Somali',
                        'SouthAfrica', 'Spain', 'SriLanka', 'St_Lucia', 'St_Vincent', 'Sudan', 'Suriname',
                        'Swaziland', 'Sweden', 'Switzerland', 'Syria', 'Taiwan', 'Tajikstan', 'Tanzania',
                        'Thailand', 'Togo', 'Tonga', 'TrinidadandTobago', 'Tunisia', 'Turkey', 'Turkmenistan',
                        'Uganda', 'Ukraine', 'UnitedArabEmirates', 'UnitedKiongdom', 'UnitedStatesofAmerica',
                        'Uruguay', 'Uzbekistan', 'Venezuela', 'Vietnam', 'Yemen', 'Yugoslavia', 'Zimbabwe',
                        'Zaire', 'Zambia'
                    ];
                }
            };
        ...
        function (postRequester, $httpParamSerializer) {
            var productSizeTable = {
                ...
                dropdown__PRODUCT_CATEGORY__JEWELRY__RINGS: {
                    UK: [
                        'H-1/2', 'I', 'I-1/2', 'J', 'J-1/2', 'K', 'K-1/2',
                        'L', 'L-1/2', 'M', 'M-1/2', 'N', 'N-1/2', 'O', 'O-1/2',
                        'P', 'P-1/2', 'Q', 'Q-1/2', 'R', 'R-1/2', 'ONE SIZE'
                    ],
                    US: [
                        '4', '4-1/4', '4-1/2', '4-3/4', '5', '5-1/4', '5-1/2',
                        '5-3/4', '6', '6-1/4', '6-1/2', '6-3/4', '7', '7-1/4',
                        '7-1/2', '7-3/4', '8', '8-1/4', '8-1/2', '8-3/4', '9', 'ONE SIZE'
                    ],
                    IT: [
                        '8', '8/9', '9', '10', '10/11', '11', '12', '12/13', '13',
                        '14', '14/15', '15', '15/16', '16', '17', '17/18',
                        '18', '18/19', '19', '19/20', '20', 'ONE SIZE'
                    ],
                    FR: [
                        46, 47, 48, 49, 49.5, 50, 50.5, 51, 52, 53, 53.5, 54,
                        54.5, 55, 55.5, 56, 57, 58, 58.5, 59, 60, 'ONE SIZE'
                    ],
                    DK: [
                        46, 47, 48, 49, 49.5, 50, 50.5, 51, 52, 53, 53.5, 54,
                        54.5, 55, 55.5, 56, 57, 58, 58.5, 59, 60, 'ONE SIZE'
                    ...
                    AU: [
                        'H-1/2', 'I', 'I-1/2', 'J', 'J-1/2', 'K', 'K-1/2', 'L',
                        'L-1/2', 'M', 'M-1/2', 'N', 'N-1/2', 'O', 'O-1/2', 'P',
                        'P-1/2', 'Q', 'Q-1/2', 'R', 'R-1/2', 'ONE SIZE'
                    ],
                ...
                dropdown__PRODUCT_CATEGORY__ACCESSORIES__HATS: {
                    UK: [
                        ...
                        '7', '7-1/8', '7-1/4', '7-3/8', '7-1/2', 'ONE SIZE'
                    ],
                    US: [
                        '6-1/2', '6-5/8', '6-3/4', '6-7/8', '7',
                        '7-1/8', '7-1/4', '7-3/8', '7-1/2', '7-5/8', 'ONE SIZE'
                    ],
                ...
                dropdown__PRODUCT_CATEGORY__FOOTWEAR__BOOTS: {
                    ...
                    IT: [
                        ...
                        39.5, 40, 40.5, 41, 41.5, 42.5, 43, 43.5, 44, 44.5, 45
                    ],
                    FR: [
                        34, 34.5, 35, 35.5, 36, 36.5, 37, 37.5, 38, 38.5, 39,
                        39.5, 40, 40.5, 41, 41.5, 42.5, 43, 43.5, 44, 44.5, 45
