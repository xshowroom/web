            ...
            <table class="table table-hover xs-table">
                ...
                <?php foreach ($pending_shop_list as $row): ?>
                    <tr>
                        ...
                        <td class="xs-row">
                            <a href="<?= URL::site('xsadmin/management/store_detail/' . $row['shop_id']); ?>"
                               target="_blank">
                        ...
                        <td class="xs-row xs-row-action">
                            <a data-toggle="modal" href="#modalAllowConfirm"
                               ng-click=<?= "clickStore(" . $row['id'] . ")"; ?>>
                                <p>ALLOW</p>
                            </a>
                        </td>
                        <td class="xs-row">
                            <a data-toggle="modal" href="#modalRejectConfirm"
                               ng-click=<?= "clickStore(" . $row['id'] . ")"; ?>>
                                <p>REJECT</p>
                            </a>
                        </td>
    ...
    <div class="modal-dialog  modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id='delete_inbox_msg' type="button" class="btn btn-type-2" ng-click="adminAllowStore();">
                    APPROVE
                </button>
            </div>
        </div><!-- /.modal-content -->
...
<div class="modal fade" id="modalRejectConfirm" tabindex="-1" role="dialog">
    <div class="modal-dialog  modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn  btn-type-1" data-dismiss="modal">CANCEL</button>
                <button id='delete_inbox_msg' type="button" class="btn btn-type-2" ng-click="adminRejectStore();">
                    REJECT
                </button>
            </div>
        </div><!-- /.modal-content -->
