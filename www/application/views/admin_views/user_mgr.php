    ...
    <div class="modal-dialog  modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id='delete_inbox_msg' type="button" class="btn btn-type-2" ng-click="adminAllowUser();">ALLOW
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade" id="modalRejectConfirm" tabindex="-1" role="dialog">
    <div class="modal-dialog  modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn  btn-type-1" data-dismiss="modal">CANCEL</button>
                <button id='delete_inbox_msg' type="button" class="btn btn-type-2" ng-click="adminRejectUser();">
                    REJECT
                </button>
            </div>
        </div><!-- /.modal-content -->
