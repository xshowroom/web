    ...
    <section class="row no-vertical-padding uploading" ng-cloak>
        <div class="container product-info">
        	<div class="row">
    			<div class="col-xs-12">
				    <ol class="breadcrumb">
					    <li><a href="<?=url::site('collection/'.$production['collection_id'])?>" target="_self"><?=$collection['name']?></a></li>
					    <li class="active"><?=$production['name']?></li>
				    </ol>
    			</div>
    		</div>
            <div class="row" ng-show="!isEditing">
                <div class="col-xs-5">
                    ...
                    <div class="product-gallery" ng-init="images = {offset: 0, urls: <?= $production['gallery_image_urls']?> };">
                    ...
                    <div class="collection-info">
                        ...
                        <div>
                            ...
                            <span><?= $collection['mode'] == 'dropdown__COLLECTION_MODE__PERMANENT' ? 'N/A' :$collection['deadline']?></span>
                        </div>
                        <div>
                            <span><?=__("product_index__COLLECTION_DELIVERY_DATE")?></span>
                            <span><?= $collection['mode'] == 'dropdown__COLLECTION_MODE__PERMANENT' ? 'N/A' :$collection['delivery_date']?></span>
                        </div>
                        <div>
