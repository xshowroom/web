			...
			<div class="row">
				...
				<div class="col-xs-6">
					<article class="request-menbership text-center">
						...
						<div>
							<a class="btn btn-type-1" href="/web/login/logout?target=brand-register" target="_self">{{ "login__REQUEST_BRAND"| translate }}</a>
							<a class="btn btn-type-1"  href="/web/login/logout?target=brand-register" target="_self">{{ "login__REQUEST_BUYER"| translate }}</a>
						</div>
					</article>
				</div>
			</div>
