	...
	<div class="row">
		<div class="col-xs-12 text-center">
			<ul class="main-naviagtions">
				...
				<li><a href="<?=URL::site('discovery');?>"  <?php if ($currentPage == 'discovery'){?>class="active"<?php }?>><?= __("global_navigation_top_guest__DISCOVER") ?></a></li>
				<li><a href="<?=URL::site('press');?>"  <?php if ($currentPage == 'press'){?>class="active"<?php }?>><?= __("global_navigation_top_guest__PRESS") ?></a></li>
				<li><a href="<?=URL::site('about');?>"  <?php if ($currentPage == 'about'){?>class="active"<?php }?>><?= __("global_navigation_top_guest__ABOUT") ?></a></li>
			</ul>
		</div>
	</div>
</div>
