<!DOCTYPE html>
<html  ng-app="xShowroom.product.edit" ng-init="productId = <?=$productId?>;collectionCategory = '<?=$collectionCategory?>';">
<head>
    <meta charset="UTF-8" >
    ...
    <script type="text/javascript" src="/static/app/modules/product_edit.js"></script>
</head>
