                        ...
                        <div class="form-group col-xs-12" ng-class="{'has-error': checkInfo.validation.collectionType}">
							...
							<div class="col-xs-10">
								...
								<label for="collection-type-men" class="checkbox-inline">
									<input type="checkbox" name="collectionType" ng-true-value="true" ng-false-value="false"
                                           ng-model="collectionType.dropdown__COLLECTION__MEN" ng-change="setCollection('dropdown__COLLECTION__MEN')" ng-disabled="!isEditing">
									{{ "dropdown__COLLECTION__MEN"| translate }}
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" name="collectionType" ng-true-value="true" ng-false-value="false"
                                           ng-model="collectionType.dropdown__COLLECTION__JEWELRY" ng-change="setCollection('dropdown__COLLECTION__JEWELRY')" ng-disabled="!isEditing">
									{{ "dropdown__COLLECTION__JEWELRY"| translate }}
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" name="collectionType" ng-true-value="true" ng-false-value="false"
                                           ng-model="collectionType.dropdown__COLLECTION__ACCESSORIES" ng-change="setCollection('dropdown__COLLECTION__ACCESSORIES')" ng-disabled="!isEditing">
									{{ "dropdown__COLLECTION__ACCESSORIES"| translate }}
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" name="collectionType" ng-true-value="true" ng-false-value="false"
                                           ng-model="collectionType.dropdown__COLLECTION__FOOTWEAR" ng-change="setCollection('dropdown__COLLECTION__FOOTWEAR')" ng-disabled="!isEditing">
