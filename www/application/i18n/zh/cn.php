...
return array_merge(
     ...
     */
    array(
        'guide__SOLUTIONS_FOR_BRANDS' => '品牌入圈指南',
        'guide__SOLUTIONS_FOR_RETAILERS' => '买手入圈指南',
        ...
        'guide__benefits_BUYER_01' => '预览众多品牌系列',
        'guide__benefits_BUYER_01_DESC' => '线上平台全年无休，供您时刻浏览新品牌新系列',
        'guide__benefits_BUYER_02' => '线下实体SHOWROOM',
        'guide__benefits_BUYER_02_DESC' => '精选品牌入驻实体SHOWROOM供买手预约参观',
        'guide__benefits_BUYER_03' => '店铺详情档案',
        'guide__benefits_BUYER_03_DESC' => '创立专属店铺档案，让品牌了解您及您的店铺详情',
        'guide__benefits_BUYER_04' => '翻译服务',
        'guide__benefits_BUYER_04_DESC' => '我们的专职客户经理将在您需要时，帮助您解决任何沟通问题，提供中英切换服务',
        'guide__benefits_BUYER_05' => '订单存档',
        'guide__benefits_BUYER_05_DESC' => '您可保存需要调整的订单，待之后进行修改并提交（品牌库存状况将影响订单确认）',
        'guide__benefits_BUYER_06' => '详细数据分析',
        'guide__benefits_BUYER_06_DESC' => '您可申请获取最精确详细的订货相关数据分析',
        'guide__benefits_BUYER_07' => '探索最新品牌',
        'guide__benefits_BUYER_07_DESC' => '从我们线上平台巨大品牌库中挖掘探索最适合您的新品牌',
        'guide__benefits_BUYER_08' => '免费入圈',
        'guide__benefits_BUYER_08_DESC' => '免费入驻XSHOWROOM买手圈成为我们的会员，无订阅费用',
        'guide__benefits_BUYER_09' => '预约参观线下空间',
        'guide__benefits_BUYER_09_DESC' => '您可与我们预约参观线下实体showroom及概念店，多方位探索新品牌',
    ...
    array(
        ...
        'brand_register__STEP_1__btn__ADD_BRAND' => '下一步',
        ...
        'brand_register__STEP_2__STORE_COLLECTION_TYPE' => '售卖系列类型 *',
        ...
        'brand_register__STEP_2__btn__ADD_COMPANY' => '下一步',
        ...
        'brand_register__STEP_3__COMPANY_ACCEPT_1' => '接收到您的申请后, 您将会收到一封邮件. 会员权限将在管理员审批后生效',
        'brand_register__STEP_3__COMPANY_ACCEPT_2' => '我接受XSHOWROOM网站上的所有条款',
    ...
    array(
        ...
        'buyer_register__STEP_2__STORE_SHIPPING_ADDRESS_PLACEHOLDER' => '收货地址 *',
        ...
        'buyer_register__STEP_3__COMPANY_ACCEPT_1' => '接收到您的申请后, 您将会收到一封邮件. 会员权限将在管理员审批后生效',
        'buyer_register__STEP_3__COMPANY_ACCEPT_2' => '我接受XSHOWROOM网站上的所有条款',
 ...
 */
    ...
    array(
        ...
        'store_index__STORE_SHIPPING_ADDRESS' => '收货地址',
    ...
    array(
        ...
        'order_index__actions__BRAND_DESCRIPTION' => '备注(装箱数量等)',
    ...
    */
    ...
    array(
        ...
        'customer_banner_TEL' => '+86 021 6236 3226',
        'customer_FAQ' => 'FAQ',
    ),
    /**
     * discovery.php
