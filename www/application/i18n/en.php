...
return array_merge(
    ...
    array(
        ...
        'guide__benefits_24_7_ACCESS' => 'VIRTUAL SHOWROOMS',
        'guide__benefits_24_7_ACCESS_DESC' => 'Virtual showrooms for our selected Brands',
        'guide__benefits_DISCOVER_BRANDS' => 'STORE PROFILE',
        'guide__benefits_DISCOVER_BRANDS_DESC' => 'Show the Brands who you are with your own store profile page',
        'guide__benefits_VIRTUAL_SHOWROOMS' => 'TRANSLATION PROVIDED',
        'guide__benefits_VIRTUAL_SHOWROOMS_DESC' => 'An Account Manager will be able to provide help to handle communication should language be a barrier (English/Chinese)',
        'guide__benefits_ONLINE_ORDER_SYSTEM' => 'SAVE FOR LATER',
        'guide__benefits_ONLINE_ORDER_SYSTEM_DESC' => 'Set up orders for purchasing later (subject to Brand availability)',
        'guide__benefits_SAVE_FOR_LATER' => 'REPORT & TRACKING STATISTICS',
        'guide__benefits_SAVE_FOR_LATER_DESC' => 'Reports and tracking statistics are available for your usage (on request)',
        'guide__benefits_KEEP_TRACK' => 'DISCOVER BRANDS',
        'guide__benefits_KEEP_TRACK_DESC' => 'Discover new brands and make new connections through our large directory',
        'guide__benefits_TRAINING' => 'FREE ACCOUNT',
        'guide__benefits_TRAINING_DESC' => 'Free membership, no subscription fees',
        'guide__benefits_DEDICATED_URL' => 'SHOWROOM APPOINTMENTS',
        'guide__benefits_DEDICATED_URL_DESC' => 'Book an appointment with us to explore the range of brands in our physical showroom and concept store',
